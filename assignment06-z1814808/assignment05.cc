...
void binTree::inorder(void(*out)(int) ) //Call Private inorder function
{
  inorder(root, out );
}

void binTree::preorder( void(*out)(int) ) //Call Private preorder function
{
  preorder(root, out);
}

void binTree::postorder( void(*out)(int) ) //Call Private post order function
{
   postorder(root, out);
}
